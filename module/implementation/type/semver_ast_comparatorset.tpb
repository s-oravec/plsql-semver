create or replace type body semver_ast_comparatorset as
    ...
    (
        range_type  in varchar2,
        comparators in semver_AstChildren
    ) return semver_ast_comparatorset is
        l_Result semver_ast_comparatorset;
    begin
        l_Result := new semver_ast_comparatorset(range_type, comparators);
    ...
    ----------------------------------------------------------------------------
    member function get_comparator_set return semver_comparator_set is
        l_comparators           semver_comparators := new semver_comparators();
        ...
        begin
            l_comparators.extend();
            l_comparators(l_comparators.last) := comparator;
        end;
    ...
    begin
        ...
        return new semver_comparator_set(l_comparators);
    exception
        when others then
